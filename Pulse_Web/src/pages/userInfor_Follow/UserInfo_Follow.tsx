...
const MyProfile = () => {
    ...
    const [isFollowing, setIsFollowing] = useState(false);  // Thêm state để theo dõi Follow/Unfollow
    ...
    const handleFollowToggle = () => {
        setIsFollowing(!isFollowing);  // Đảo ngược trạng thái Follow/Unfollow
    };
        ...
        <main className="bg-[#1F1F1F] text-white">
            ...
            <div className="relative px-4 -mt-16 flex flex-col items-start">
                ...
                <div className="mt-4 flex items-center justify-between w-full">
                    ...
                    {/* Thêm sự kiện onClick để thay đổi trạng thái Follow/Unfollow */}
                    <button
                        className="text-white px-4 py-2 bg-zinc-700 rounded-full hover:bg-zinc-800 cursor-pointer"
                        onClick={handleFollowToggle}
                    >
                        {isFollowing ? "Unfollow" : "Follow"}  {/* Hiển thị Follow hoặc Unfollow */}
                    </button>
                </div>
